...
pub fn build(b: *std.build.Builder) !void {
    ...
    try buildFlightBooker(b, target, mode);
}
...
pub fn buildFlightBooker(b: *std.build.Builder, target: std.zig.CrossTarget, mode: std.builtin.Mode) !void {
    const example_app = try mach.App.init(
        b,
        .{
            .name = "flight-booker",
            .src = "./03-flight-booker/main.zig",
            .target = target,
            .deps = &[_]Pkg{mach_imgui_pkg},
        },
    );
